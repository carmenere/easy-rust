...
| Adapter                                                                                    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|:-------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**all(f)**](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.all)            | Tests if **predicate** `f` returns `true` for **all** elements. On **empty** returns `true`.                                                                                                                                                                                                                                                                                                                                                                       |
| [**any(f)**](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.any)            | Tests if **predicate** `f` returns `true` **at least for 1** element. On **empty** returns `false`.                                                                                                                                                                                                                                                                                                                                                                |
